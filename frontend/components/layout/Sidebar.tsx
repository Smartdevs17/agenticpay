...
import { X, LayoutDashboard, Folder, CreditCard, Settings, LogOut, FileText } from 'lucide-react';
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`
                    flex items-center gap-3 px-4 py-3.5 rounded-xl text-sm font-semibold transition-all active:scale-95 touch-manipulation
                    ${isActive
